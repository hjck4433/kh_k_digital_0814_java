...
//        System.out.println("나눗셈 : " + ((double)num1 / num2)); //num2=0 이되면 ArithmeticException
//        System.out.println("나머지 : " + (num1 % num2)); // 알고리즘 문제에서 자주 등장
//        System.out.println("몫 :" + (num1 / num2));
        
        // 대입 연산자 : 변수에 값을 대입하는 연산자( = ), 프로그램에서 = 같다라는 의미가 아니고 대입한다는 의미
//        System.out.println(num1 += 2); //복합대입 연산자 : num1 = num1 + 2; num1에 대입된 값이 있어야 함
//        System.out.println(num1 -= 2); //복합대입 연산자 : num1 = num1 - 2;
//        System.out.println(num1 *= 2); //복합대입 연산자 : num1 = num1 * 2; 관례상 *, / 는 잘 사용하지 않음
//        System.out.println(num1 /= 2); //복합대입 연산자 : num1 = num1 / 2; 관례상 *, / 는 잘 사용하지 않음
        // 증감 연산자 : 단항연산자, 피연산자의 값을 1증가 또는 1감소 시키는 연산자
        //System.out.println(num1++);
//        int tmp = num1++;
//        System.out.println(tmp); // 10을 먼저 대입 후 1증가
//        System.out.println(num1); // 11 
        // 비교 연산자 : 두개의 피연사자를 비교해서 어느쪽이 큰지를 판단
        int x = 10;
        int y = 20;
...
//        System.out.println(x >= y); // 거짓 false
//        System.out.println(x <= y); // 참 true
        // 논리 연산자 : && (AND 연산자 : 둘다 참인 경우 참), || (OR 연산자 : 둘 중 하나만 참이면 참) 
