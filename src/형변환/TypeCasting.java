...
//        System.out.println(result2);
        ...
        String kor = "90";
        //int intKor = Integer.parseInt(kor); // 문자열을 숫자로 변환하는 메소드 / 문자가 포함되어 있으면 Error
        int mat = 88;
        int eng = 55;
        int total = /*intKor*/ Integer.parseInt(kor) + mat + eng; // 총점
        double avg = (double)total / 3; //3이 묵시적으로 double로 형변환이 일어남
