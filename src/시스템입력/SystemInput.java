...
public class SystemInput {
    public static void main(String[] args) {
        // 클래스는 설계도면이라고 생각하면 됨
        Scanner sc = new Scanner(System.in); // 스캐너에 대한 객체 생성 / new => 메모리에 동적 할당
        /*
        byte a = sc.nextByte(); // byte형의 입력을 받아 반환
        ...
        */
        ...
        String name = sc.nextLine(); // 이름을 입력 받은 후 공백이나 줄바꿈이 일어나면 다음으로 넘어감
        sc.nextLine(); // 버퍼 비우기
